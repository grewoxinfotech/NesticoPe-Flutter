...
class _ContractorInquiryQuotationScreenState
  ...
  void _initializeFormData() {
    ...
    if (widget.isEditMode && widget.quotation != null) {
      ...
      _selectedGSTPercentage.value =
          (widget.quotation!.meta.gstPercentage ?? 0).toInt();
      _gstController.text = _selectedGSTPercentage.value.toString();
                        ...
                        if (_isGSTIncluded.value) ...[
                          ...
                          Expanded(
                            child: TextFormField(
                              ...
                              onChanged: (value) {
                                final gstValue = int.tryParse(value) ?? 0;
                                if (gstValue >= 0 && gstValue <= 100) {
                                  _selectedGSTPercentage.value = gstValue;
                                }
                              },
                              decoration: InputDecoration(
                                hintText: 'Enter GST %',
                              ...
                              validator: (value) {
                                if (_isGSTIncluded.value) {
                                  ...
                                  final gstValue = int.tryParse(value);
                                  if (gstValue == null) {
                                    return 'Please enter a valid number';
                                  }
                                  if (gstValue < 0 || gstValue > 100) {
