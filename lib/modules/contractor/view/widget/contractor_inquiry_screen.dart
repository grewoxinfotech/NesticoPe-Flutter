...
class ContractorInquiryScreen extends StatefulWidget {
  ...
  @override
  State<ContractorInquiryScreen> createState() => _ContractorInquiryScreenState();
}
                  ...
                  itemBuilder: (context, index) {
                    ...
                    return Obx(
                      () => InquiryCard(
                        ...
                        onToggle: () => controller.toggleCard(inquiry.id),
                        onChangeStatus:
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      if ((inquiry.meta.propertyType?.isNotEmpty ?? false) ||
                          (inquiry.meta.bhk != null && inquiry.meta.bhk!=null) ||
                        ...
                        Wrap(
                          ...
                          children: List.generate(
                            inquiry.services.length,
                              ...
                              return _chip(
                                service.serviceName,
                                isConverted ? ColorRes.success : ColorRes.leadGreyColor.shade400,
                              );
                            },
                          ),
                        ),
                      ...
                      if (inquiry.meta.serviceDescription?.trim().isNotEmpty ?? false) ...[
                        const SizedBox(height: 12),
                        _buildSectionTitle('Service Description'),
                        const SizedBox(height: 8),
                        Text(
