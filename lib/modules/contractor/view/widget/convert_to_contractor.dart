...
class ConvertToContractorConversionScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final List<String> options = [
      "Your account will be converted to a contractor account",
      "You can immediately start offering your service",
      "Create service listing and receive project proposals",
