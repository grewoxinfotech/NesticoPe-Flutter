...
class ContractorAllReviewScreen extends StatefulWidget {
        ...
        return SingleChildScrollView(
          child: Column(
            children: [
              ...
              ContractorAllReviewVerticalAndTestimonials(
...
class ContractorAllReviewVerticalAndTestimonials extends StatelessWidget {
  final PlatformReviewController reviewController; // ← a
  const ContractorAllReviewVerticalAndTestimonials({
    super.key,
        ...
        Obx(() {
          ...
          return ListView.separated(
            ...
            itemBuilder: (context, index) {
              return _buildContractorAllReviewVerticalCard(
                context,
