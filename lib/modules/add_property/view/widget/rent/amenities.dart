  ...
  Widget build(BuildContext context) {
    return Obx(() {
      if ((controller.lookingTo.value == "Rent" ||
        ...
        return (controller.rent_propertyType.value.toLowerCase() == "plot" ||
                        ...
                        return Padding(
                          ...
                          child: GestureDetector(
                            ...
                            onTap: () {
                              if (e.isMultiChoice) {
                                final furnishing =
                                    controller.selectedFurnishing[e.key];
                                if (furnishing != null) {
                ...
                Wrap(
                  ...
                  children:
                      IconManager.amenitiesItems.map((e) {
                        final isSelected = controller.selectedRoomAmenities
                            .contains(e.key);
          ...
          children: [
            ...
            Obx(() {
              ...
              return Wrap(
                ...
                children:
                    amenitiesList.map((e) {
                      final isSelected = controller.selectedCommercialAmenities
                          .contains(e.title);
