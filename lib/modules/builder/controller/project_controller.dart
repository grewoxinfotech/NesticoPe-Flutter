...
import '../../../data/network/builder/model/builder_model.dart' hide ProjectContactInfo, ProjectSize, MediaGallery, Brochure;
import '../../../data/network/builder/model/builder_projectModel.dart';
class ProjectController extends GetxController {
  final Rx<ProjectItem?> project = Rx<ProjectItem?>(null);
...
// Add these methods
  ...
  void downloadDocument(String? path) {
    if (path != null) {
      Get.snackbar('Download', 'Downloading document...',
          snackPosition: SnackPosition.BOTTOM);
    }
  }

  void contactSales(String type) {
    Get.snackbar('Contact', 'Opening $type...',
        snackPosition: SnackPosition.BOTTOM);
  }
}
