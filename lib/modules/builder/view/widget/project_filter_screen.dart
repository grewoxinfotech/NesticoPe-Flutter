                          ...
                          final filterData = {
                            ...
                            'hasBrochure':
                                controller.isPropertyHaveBroucher.value
                                    .toString(),
                            if(controller.max.value != 0.0 || controller.min.value != 0)'minPrice': controller.min.value.toString(),
                            if(controller.max.value != 0.0)'maxPrice': controller.max.value.toString(),
