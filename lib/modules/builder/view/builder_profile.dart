          ...
          Row(
            children: [
              Container(
                ...
                height: 70,
                decoration: BoxDecoration(
                 image: DecorationImage(image: NetworkImage('https://images.unsplash.com/photo-1503387762-592deb58ef4e?w=400'),fit: BoxFit.cover),
            ...
            children: [
              Expanded(
                child: OutlinedButton(
                  ...
                  child:  Text('Edit Profile',style: TextStyle(fontSize:AppFontSizes.small,letterSpacing: 0.5 ),),
                ),
              ),
              ...
              Expanded(
                child: ElevatedButton(
                  ...
                  child: Text('Contact Support',style: TextStyle(fontSize:AppFontSizes.small,letterSpacing: 0.5 ),),
                ),
              ),
            ],
          ),
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          ReadMoreClass(description: 'Prestige Builders is a premier real estate development firm specializing in luxury residential properties. With over a decade of experience, we have a proven track record of delivering high-quality homes that exceed expectations.', trimLines: 4, size: AppFontSizes.extraSmall, colorClickableText: ColorRes.primary),
        ],
      ),
    );
  }
        ...
        children: [
          Row(
            ...
            children: [
              ...
              TextButton(
                onPressed: () {},
                child:  Text('View All',style: TextStyle(fontSize: AppFontSizes.caption),),
              ),
            ],
          ),
                ...
                Row(
                  ...
                  children: [
                    Container(
                      ...
                      child: Text(
                        status,
                        style:  TextStyle(fontSize: AppFontSizes.extraSmall,fontWeight: AppFontWeights.medium,color: statusColor),
                      ),
                    ),
                    ...
                    if (price.isNotEmpty) ...[
                      ...
                      Text(
                        ...
                        style: const TextStyle(
                            fontSize: AppFontSizes.small,fontWeight: AppFontWeights.medium
                        ),
                      ),
                    ]else...[
                      const SizedBox(width: 8),
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          const SizedBox(height: 12),
          _buildReview('Jane D.', 'Flawless process from start to finish. Highly recommend!'),
          const SizedBox(height: 12),
          _buildReview('Mark S.', 'The quality of construction is top-notch. Very impressed.'),
        ],
      ),
    );
  }
        ...
        children: [
          Row(
            children: [
              ...
              Text(
                name,
                style:TextStyle(fontWeight: AppFontWeights.semiBold,fontSize: AppFontSizes.medium,color: ColorRes.textPrimary),
              ),
              const SizedBox(width: 8),
              ...List.generate(
                5,
          ...
          //   style: TextStyle(fontSize: AppFontSizes.extraSmall, color: ColorRes.leadGreyColor[700]),
          // ),
          ReadMoreClass(description: review, trimLines: 3, size: AppFontSizes.extraSmall, colorClickableText: ColorRes.primary)
        ],
      ),
    );
  }
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          const SizedBox(height: 16),
          _buildTeamMember('Sarah Johnson', 'Lead Architect','https://i.pravatar.cc/300?img=11'),
          const SizedBox(height: 12),
          _buildTeamMember('Michael Chen', 'Project Manager','https://i.pravatar.cc/300?img=22'),
          const SizedBox(height: 16),
          Container(
