...
//                     maxCount: 1,
//                     items: controller.model != null ? [controller.model!] : [],
//                     isVideo: false,
//                     onRemove: controller.remove3DModel,
//                     projectId: widget.projectId,
//                     variantId: widget.variantId,
//                   ),
//                   const SizedBox(height: 24),
...
class MediaPreviewList extends StatelessWidget {
  ...
  Widget _buildEmptyState() {
    String emptyText = 'No images selected';
    String helperText = 'Add up to 5 images';
    IconData emptyIcon = Icons.photo_library_outlined;

    if (isVideo) {
      emptyText = 'No videos selected';
      helperText = 'Add up to 3 videos';
      emptyIcon = Icons.video_library_outlined;
    } else if (is3DModel) {
      emptyText = 'No 3D model selected';
      helperText = 'Add 1 model file';
