...
class LeadFollowUpScreen extends StatefulWidget {
  final LeadVisitController controller;

  LeadFollowUpScreen({super.key, required this.controller});
...
class _LeadFollowUpScreenState extends State<LeadFollowUpScreen> {
  ...
  void initState() {
    super.initState();
    controller.initFollowups(widget.controller.leadIdFollowUp.toString() ?? "");
  }

  @override
  Widget build(BuildContext context) {
    WidgetsBinding.instance.addPostFrameCallback((_) {
      controller.initFollowups(
        widget.controller.leadIdFollowUp.toString() ?? "",
      );
    });
    return Scaffold(
