...
class ContractorProjectModel {
  ...
  ContractorProjectModel copyWith({
    bool? success,
    String? message,
    ContractorProjectData? data,
  }) {
    return ContractorProjectModel(
...
class ContractorProjectData {
  ...
  ContractorProjectData copyWith({
    List<ContractorProjectItem>? items,
    int? total,
    int? currentPage,
    int? totalPages,
    bool? hasMore,
...
class ContractorProjectItem {
  ...
  factory ContractorProjectItem.fromJson(Map<String, dynamic> json) {
    return ContractorProjectItem(
      ...
      createdAt: json['createdAt'] ?? '',
      updatedAt: json['updatedAt'] ?? '',
      projectPrice: json['price']?.toString() ?? '0',
    );
  }
...
class ContractorProjectClient {
  ...
  ContractorProjectClient copyWith({
    String? name,
    String? email,
    String? phone,
    String? propertyType,
...
class ContractorProjectMeta {
  ...
  ContractorProjectMeta copyWith({
    String? serviceId,
    String? serviceName,
    String? inquiryId,
...
class ContractorEmployee {
  ...
  ContractorEmployee({required this.id});

  factory ContractorEmployee.fromJson(Map<String, dynamic> json) {
    return ContractorEmployee(id: json['id'] ?? '');
  }

  Map<String, dynamic> toJson() => {'id': id};

  ContractorEmployee copyWith({String? id}) {
    return ContractorEmployee(id: id ?? this.id);
  }
}
