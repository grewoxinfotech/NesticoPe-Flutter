...
class ContractorQuotation {
  ...
  factory ContractorQuotation.fromMap(Map<String, dynamic> map) {
    return ContractorQuotation(
      ...
      user: QuotationUser.fromMap(map['user'] as Map<String, dynamic>),
      price: map['price']?.toString() ?? '0',
      status: map['status'] ?? '',
      meta:
          map['meta'] != null
              ? QuotationMeta.fromMap(map['meta'] as Map<String, dynamic>)
              : QuotationMeta.empty(),
      isConverted: map['is_converted'] ?? false,
...
class QuotationMeta {
  ...
  factory QuotationMeta.fromMap(Map<String, dynamic> map) {
    ...
    return QuotationMeta(
      ...
      // fallback logic
      originalPrice: safeDouble(map['originalPrice'] ?? map['basePrice']),
      basePrice: safeDouble(map['basePrice']),

      // Pricing / GST
      isGstEnabled: map['isGstEnabled'],
      discountPercentage: safeDouble(map['discountPercentage']),
      discountAmount: safeDouble(map['discountAmount']),
      totalPrice: safeDouble(map['totalPrice']),
      discountReason: map['discountReason'],
      gstPercentage: safeDouble(map['gstPercentage']),
      gstAmount: safeDouble(map['gstAmount']),

      inquiryCustomerId: map['inquiryCustomerId'] ?? '',

      expectedStartDate:
          map['expectedStartDate'] != null
              ? DateTime.parse(map['expectedStartDate'])
              : DateTime.now(),

      propertyDetails:
          map['propertyDetails'] != null
              ? PropertyDetails.fromMap(map['propertyDetails'])
              : null,

      inquiryServices:
          map['inquiryServices'] != null
      ...
      electricalWiresBrand: List<String>.from(
        map['electricalWiresBrand'] ?? [],
      ),
      electricalSwitchesBrand: List<String>.from(
        map['electricalSwitchesBrand'] ?? [],
      ),
      plumbingPipesBrand: List<String>.from(map['plumbingPipesBrand'] ?? []),
      sanitaryFittingsBrand: List<String>.from(
        map['sanitaryFittingsBrand'] ?? [],
      ),
      ...
      design3D: map['threeDDesign'] ?? map['design3D'],
    );
  }
...
//       // Map all brand/type lists
//       cementBrand:
//           map['cementBrand'] != null
//               ? List<String>.from(map['cementBrand'])
//               : [],
//       steelBrand:
//           map['steelBrand'] != null ? List<String>.from(map['steelBrand']) : [],
//       brickType:
//           map['brickType'] != null ? List<String>.from(map['brickType']) : [],
//       sandSource:
//           map['sandSource'] != null ? List<String>.from(map['sandSource']) : [],
//       electricalWiresBrand:
//           map['electricalWiresBrand'] != null
//               ? List<String>.from(map['electricalWiresBrand'])
//               : [],
//       electricalSwitchesBrand:
//           map['electricalSwitchesBrand'] != null
//               ? List<String>.from(map['electricalSwitchesBrand'])
//               : [],
//       plumbingPipesBrand:
//           map['plumbingPipesBrand'] != null
//               ? List<String>.from(map['plumbingPipesBrand'])
//               : [],
//       sanitaryFittingsBrand:
//           map['sanitaryFittingsBrand'] != null
//               ? List<String>.from(map['sanitaryFittingsBrand'])
//               : [],
//       waterTankBrand:
//           map['waterTankBrand'] != null
//               ? List<String>.from(map['waterTankBrand'])
//               : [],
//       flooringTilesBrand:
//           map['flooringTilesBrand'] != null
//               ? List<String>.from(map['flooringTilesBrand'])
//               : [],
//       interiorPaintBrand:
//           map['interiorPaintBrand'] != null
//               ? List<String>.from(map['interiorPaintBrand'])
//               : [],
//       exteriorPaintBrand:
//           map['exteriorPaintBrand'] != null
//               ? List<String>.from(map['exteriorPaintBrand'])
//               : [],
//       doorsType:
//           map['doorsType'] != null ? List<String>.from(map['doorsType']) : [],
//       windowsType:
//           map['windowsType'] != null
//               ? List<String>.from(map['windowsType'])
//               : [],
//       fabricationWork:
//           map['fabricationWork'] != null
//               ? List<String>.from(map['fabricationWork'])
//               : [],
//       structure:
//           map['structure'] != null ? List<String>.from(map['structure']) : [],
//       plasterType:
//           map['plasterType'] != null
//               ? List<String>.from(map['plasterType'])
//               : [],
//       waterproofing:
//           map['waterproofing'] != null
//               ? List<String>.from(map['waterproofing'])
//               : [],
//       chokhatType:
//           map['chokhatType'] != null
//               ? List<String>.from(map['chokhatType'])
//               : [],
//       railingType:
//           map['railingType'] != null
//               ? List<String>.from(map['railingType'])
//               : [],
//       falseCeiling:
//           map['falseCeiling'] != null
//               ? List<String>.from(map['falseCeiling'])
//               : [],
//       modularKitchen: map['modularKitchen'],
//       boreAndPump: map['boreAndPump'],
//       securitySystems: map['securitySystems'],
